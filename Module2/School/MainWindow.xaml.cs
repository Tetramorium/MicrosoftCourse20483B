...
namespace School
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void removeStudent(Student _Student)
        {
            ...
            MessageBoxResult response = MessageBox.Show(
                String.Format("Remove {0}", _Student.FirstName + " " + _Student.LastName),
            ...
            {
                this.schoolContext.Students.DeleteObject(_Student);
